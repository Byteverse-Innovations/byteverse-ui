...
export default function Login() {
  ...
  const [newPasswordFormError, setNewPasswordFormError] = useState<string | null>(null)
  ...
  const handleNewPasswordSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    clearError()
    setNewPasswordFormError(null)
    if (newPassword !== confirmPassword) {
      setNewPasswordFormError('Passwords do not match.')
      return
    }
  ...
  const authOrFormError = error ?? newPasswordFormError
